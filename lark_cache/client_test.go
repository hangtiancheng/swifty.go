...
func TestClientMethods(t *testing.T) {
	client := &Client{grpcCli: &fakeLarkCacheClient{
...
type fakeLarkCacheClient struct {
	getFunc    func(ctx context.Context, in *pb.Request, opts ...grpc.CallOption) (*pb.ResponseForGet, error)
	setFunc    func(ctx context.Context, in *pb.Request, opts ...grpc.CallOption) (*pb.ResponseForGet, error)
	deleteFunc func(ctx context.Context, in *pb.Request, opts ...grpc.CallOption) (*pb.ResponseForDelete, error)
}

func (c *fakeLarkCacheClient) Get(ctx context.Context, in *pb.Request, opts ...grpc.CallOption) (*pb.ResponseForGet, error) {
	return c.getFunc(ctx, in, opts...)
}

func (c *fakeLarkCacheClient) Set(ctx context.Context, in *pb.Request, opts ...grpc.CallOption) (*pb.ResponseForGet, error) {
	return c.setFunc(ctx, in, opts...)
}

func (c *fakeLarkCacheClient) Delete(ctx context.Context, in *pb.Request, opts ...grpc.CallOption) (*pb.ResponseForDelete, error) {
