...
replace (
	github.com/hangtiancheng/lark-go/lark_cache => ../lark_cache
	github.com/hangtiancheng/lark-go/lark_http => ../lark_http
	github.com/hangtiancheng/lark-go/lark_orm => ../lark_orm
)
