...
func Login(ctx *lark_http.Context, next func()) {
	var req struct {
...
func Register(ctx *lark_http.Context, next func()) {
	var req struct {
		Telephone string `json:"telephone"`
		Password  string `json:"password"`
...
func UpdateUserInfo(ctx *lark_http.Context, next func()) {
	var req struct {
...
func GetUserInfo(ctx *lark_http.Context, next func()) {
	var req struct {
		Uuid string `json:"uuid"`
	}
	if err := ctx.BindJSON(&req); err != nil {
...
func GetUserInfoList(ctx *lark_http.Context, next func()) {
	var req struct {
...
func AbleUsers(ctx *lark_http.Context, next func()) {
	var req struct {
...
func DisableUsers(ctx *lark_http.Context, next func()) {
	var req struct {
		UuidList []string `json:"uuid_list"`
	}
	if err := ctx.BindJSON(&req); err != nil {
...
func DeleteUsers(ctx *lark_http.Context, next func()) {
	var req struct {
		UuidList []string `json:"uuid_list"`
	}
	if err := ctx.BindJSON(&req); err != nil {
...
func SetAdmin(ctx *lark_http.Context, next func()) {
	var req struct {
		UuidList []string `json:"uuid_list"`
		IsAdmin  int8     `json:"is_admin"`
	}
