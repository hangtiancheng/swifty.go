...
- **Minute-sharded Redis zsets** — tasks land in `swifty_time_wheel_task_{minute}` scored by their execution-time unix seconds. Old shards age out naturally.
...
```bash
go get github.com/hangtiancheng/swifty.go/apps/time_wheel
```
