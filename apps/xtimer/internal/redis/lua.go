...
// LuaCheckAndDeleteDistributionLock deletes the lock only when the caller owns it.
...
// LuaCheckAndExpireDistributionLock refreshes the lock expiry only when the
// caller owns it.
