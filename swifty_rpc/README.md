...
Module path: `github.com/hangtiancheng/swifty.go/swifty_rpc`
...
import (
    ...
    "github.com/hangtiancheng/swifty.go/swifty_rpc/pkg/api"
...
func main() {
    ...
    log.Println("swifty_rpc server listening on :8080")
...
The `Registry` connects to an etcd v3 cluster and stores service instances under a key prefix (`/github.com/hangtiancheng/swifty.go/swifty_rpc/services/<service>/<addr>`).
