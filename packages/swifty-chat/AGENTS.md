...
# Swifty Intent - before editing files, run the matching guidance command.

swiftyIntent:

- id: "@swifty.js/sentry#swifty-sentry"
  run: "npx @tanstack/intent@latest load @swifty.js/sentry#swifty-sentry"
  for: "Integration guide for @swifty.js/sentry, a browser monitoring and analytics SDK.
...
- id: "@swifty.js/lit-jsx#swifty-lit-jsx"
  run: "npx @tanstack/intent@latest load @swifty.js/lit-jsx#swifty-lit-jsx"
